...
public class MainActivity extends BaseSlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initActionBar();//初始化bar
		initSlidingMenu();//初始化men
	...
	private void initActionBar() {
		getSupportActionBar().setDisplayHomeAsUpEnabled(true);       //启用ActionBar图标导航功能
		getSupportActionBar().setBackgroundDrawable(
				getResources().getDrawable(R.drawable.topbar_tile_bg));//getResources返回什么？
		getSupportActionBar().setDisplayUseLogoEnabled(true);
		getSupportActionBar().setLogo(R.drawable.ic_logo_actionbar);

		/*
		加载一个项目布局 ，使用定制界面的actionbar
		 */
		...
		getSupportActionBar().setDisplayShowCustomEnabled(true);  //设置
